document.addEventListener("DOMContentLoaded", async () => {
  ...
  await loadStaffStocksOverview();
});

async function loadStaffStocksOverview() {
  const container = document.getElementById("staffStocksOverview");
  if (!container) return;
  ...
  try {
    ...
    console.error("loadStaffStocksOverview error:", error);
    container.innerHTML = `
      <div class="overview-card">
